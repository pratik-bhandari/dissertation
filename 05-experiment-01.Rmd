...
It contains information in a given situation about a topic of conversation, semantic and syntactic information of a sentence structure, world knowledge, visual information, etc.[@Kaiser2004; @Knoeferle2005; @Altmann2007; @Xiang2015; for reviews, @Stilp2020].
...
Processing and comprehending degraded speech is more effortful and requires more attentional resources than that for clear speech [@Wild2012; @Eckert2016; @Peelle2018].
...
When the bottom-up speech signal is less informative in an adverse listening condition, listeners rely more on the context information to support language comprehension [@Sheldon2008b; @Obleser2010; @Amichetti2018].
...
Materials used in the experiment were created by the method described in [Chapter 3](#experimental-materials).
...
Response accuracy was analyzed with Generalized Linear Mixed Models (GLMMs) following the procedure described in [Chapter 4](#analysis-main).
...
Aiming for model parsimony, the best fitting model among the parsimonious and extended models was then selected as the optimal model for our data. Model selection was based on AIC [@Burnham2002; @Grueber2011; @Richards2011].
...
Also, when speech is degraded, top-down predictions render a benefit in word recognition and language comprehension [e.g., @Sheldon2008b; @Sheldon2008a; @Corps2020].
