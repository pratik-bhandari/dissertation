...
We varied the task instructions to the listeners from [Experiment 1](#experiment1a) to [Experiment 2](#experiment1b), which required them to differentially attend to the target word not binding the context or including the context.
...
We first fitted a model with a maximal random effects structure that included random intercepts for each participant and item [@Barr2013].
...
It is not implausible that the listeners listened to the context but did not do deep processing [cf. @Ferreira2016].
