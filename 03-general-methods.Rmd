...
Digital algorithms like pitch-synchronous overlap-add technique [PSOLA, @Charpentier1986; @Moulines1990] developed in the 1980s and later [e.g., @Verhelst1993] now allow us to speed up and slow down the speech rate in a controlled fashion.
...
As discussed [earlier](#research-goals), the main aim of the manipulation of this bottom-up process is to investigate the effect of change in the rate of information flow (i.e., change in the speech rate), on the top-down processes of contextual facilitation in degraded speech comprehension.
