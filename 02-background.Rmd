...
Among older adults, those with lower working working memory scores are shown to be further disadvantaged when it comes to the use of context information [@Federmeier2002; @Federmeier2010].
A different line of argument that critiques the entire predictive processing domain comes from observations by @Huettig2019.
