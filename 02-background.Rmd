...
However, speech perception is hardly as smooth as it seems.<!-- hardly as simple as it is described in the preceding sentence.-->
...
Shannon and colleagues later used the same technique as an analogue to cochlear implant such that number of channels used in a cochlear implant are similar to the number of noise vocoding channels in terms of their speech output and intelligibility [@Shannon1995; @Loizou1999; @Shannon2004].
...
### Facilitatory effect of predictability
