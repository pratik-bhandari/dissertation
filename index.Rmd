...
university-logo: templates/beltcrest.png
...
use-biblatex: true
bib-latex-options: "style=authoryear, sorting=nyt, backend=biber, maxcitenames=2, useprefix, doi=true, isbn=false, uniquename=false, dashed=false, url=false" #for science, you might want style=numeric-comp, sorting=none for numerical in-text citation with references in order of appearance
...
output:
  bookdown::pdf_book:
    ...
    latex_engine: xelatex # I added on 04/04/2022 when knitting started to throw UTF+08 error
  bookdown::bs4_book: 
    css: 
