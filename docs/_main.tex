...
\item
  ...
  For example, in a multi-lab collaborative study, Nieuwland et al. (\protect\hyperlink{ref-Nieuwland2020a}{2020}) did not find the same N400 effect in English articles (a/an) that DeLong et al. (\protect\hyperlink{ref-Delong2005}{2005}) had reported 15 years earlier.
...
In this chapter, we provide background on the noisy channel created and used to introduce variations in bottom-up processing in the studies presented in this thesis.
...
For example, listeners are shown to rate 8-channel noise-vocoded speech to be more intelligible and less effortful than 2 channels noise-vocoded speech (e.g., \protect\hyperlink{ref-Obleser2011}{Obleser \& Kotz, 2011}; \protect\hyperlink{ref-Sohoglu2012}{Sohoglu et al., 2012}).
...
Similarly, Scholman et al. (\protect\hyperlink{ref-Scholman2020}{2020}) demonstrated that literacy is predictive of readers' sensitivity to discourse signals available in the context for predictiong upcoming content.
Cognitive ageing is also reported as a limiting factor in generating predictions.
Smaller N400 amplitude and latency in older adults compared to younger adults have been shown as evidence of the inability of older adults to engage in predictive language processing (\protect\hyperlink{ref-Federmeier2002}{K. Federmeier et al., 2002}).
Furthermore, among older adults, those with lower working memory scores are shown to be further disadvantaged when using context information (\protect\hyperlink{ref-Federmeier2010}{K. D. Federmeier et al., 2010}).
...
They analyzed participants' anticipatory eye movements in the visual world paradigm and showed that listeners predict the target word only in an \emph{artificial} setup of long preview time coupled with slow speech (cf. \protect\hyperlink{ref-Fernandez2020}{Fernandez et al., 2020}; \protect\hyperlink{ref-Heyselaar2021}{Heyselaar et al., 2021}).
...
Most importantly, it allows fine-grained control over speech intelligibility by varying the number of vocoder channels.
...
In Experiment \protect\hyperlink{experiment1b}{2} of Chapter \ref{chapter-attention-prediction}, there was an implicit assumption that all the noun-correct responses were borne out of a correct identification of the context evoking words (i.e., verbs).
...
In the literature of speech perception and sentence processing, studies have argued that prediction is either probabilistic and graded, or it is an all-or-nothing phenomenon (e.g., \protect\hyperlink{ref-Coltheart2004}{Coltheart, 2004}; \protect\hyperlink{ref-Kuperberg2016}{Kuperberg \& Jaeger, 2016}; \protect\hyperlink{ref-Luke2016}{Luke \& Christianson, 2016}).
...
Davis et al. (\protect\hyperlink{ref-Davis2005}{2005}) and Erb et al. (\protect\hyperlink{ref-Erb2013}{2013}) presented participants with 4- and 6-channel noise-vocoded speech, respectively in a single block.
...
Such changes in the auditory features of the speech signal throughout the experiment is likely to render the perceptual adaptation totally absent (\protect\hyperlink{ref-Mattys2012}{Mattys et al., 2012}).
Additionally, the trial-by-trial variability in the characteristics of speech signal can also impair word recognition (\protect\hyperlink{ref-Sommers1994}{Sommers et al., 1994}; see also \protect\hyperlink{ref-Dahan2006}{Dahan \& Magnuson, 2006}).
...
For example, in a study by Vaden et al. (\protect\hyperlink{ref-Vaden2013}{2013}), participants were presented with words in a background noise at +3dB SNR and +10dB SNR in a pseudo-random order.
...
So, we cannont derive a conclusion from these studies regarding the effect of (un)certainty of the \emph{global channel context} in perceptual adaptation and contextual facilitation.
...
In contrast to prior studies (e.g., \protect\hyperlink{ref-Obleser2010}{Obleser \& Kotz, 2010}), inclusion of sentences with medium cloze target words thus allows us to differentiate whether listeners form all-or-nothing prediction restricted to high cloze target words, or a probabilistic prediction for words across a wide range of cloze probability.
...
We recruited a group of participant via Prolific Academic (\protect\hyperlink{ref-Prolific}{Prolific, 2014}) and assigned them to the \emph{predictable channel context} (n = 50; \(M\) age \(\pm SD=23.6\pm\) 3.2 years; age range = 18-30 years; 14 females).
...
In the \emph{unpredictable channel context}, the sentences were pseudo-randomized across degradation predictability conditions.
No more than three sentences of the same degradation and predictability condition appeared consecutively.
In the \emph{predictable channel context}, sentences in were blocked by degradation level.
...
\caption{Mean response accuracy across all conditions in Experiment 2. Accuracy increased only with an increase in the number of noise-vocoding channels in both channel contexts. Only in the unpredictable globlal channel context, at the 4-channel noise-vocoding condition, we find a graded effect of prediction. Error bars represent the standard error of the means.}\label{fig:figure2}
\end{figure}
...
To rule out this possible explanation of our findings, we conducted an additional analysis compareing the \emph{forward predictability effect} (from verb to noun) to the size of \emph{backward predictability effect} (correct identification of the noun based on the final verb).
...
which can be facilitated by a feedback from higher-level lexical information (\protect\hyperlink{ref-Goldstone1998}{Goldstone, 1998}; \protect\hyperlink{ref-Mattys2012}{Mattys et al., 2012}; cf. \protect\hyperlink{ref-Davis2005}{Davis et al., 2005}).
...
As Goldstone (\protect\hyperlink{ref-Goldstone1998}{1998}), p.~588 notes -- ``one way in which perception becomes adapted to tasks and environments is by increasing the attention paid to perceptual dimensions and features that are important, and/or by decreasing attention to irrelevant {[}perceptual{]} dimensions and features'' (see also \protect\hyperlink{ref-Gold2010}{Gold \& Watanabe, 2010}).
...
hence, one could simply use the word recognition score without considering the context recognition (e.g., \protect\hyperlink{ref-vanOs2021}{van Os et al., 2021}).
...
and listeners do not necessarily identify visually presented context (e.g., visual half-field recognition superiority, \protect\hyperlink{ref-McKeever1977}{McKeever \& VanDeventer, 1977})
...
On the one hand, clean speech perception and reading studies have shown that contextual facilitation decreases with an increase in presentation rate (e.g., fast speech), with a mixed evidence on the enhancement of contextual facilitation with a decrease in presentation rate (e.g., slow speech).
...
Specifically for degraded speech, there is no clear evidence on how the facilitatory effect at a moderate level of degradation is affected by different speech rates (\protect\hyperlink{ref-Iwasaki2002}{Iwasaki et al., 2002}; \protect\hyperlink{ref-Meng2019}{Meng et al., 2019}; \protect\hyperlink{ref-Winn2021}{M. B. Winn \& Teece, 2021}).
...
An increase (or decrease) in listening effort by a change in speech rate limits the cognitive resources available to encode the context information and form predictions (cf. \protect\hyperlink{ref-Huettig2016}{Huettig \& Mani, 2016}).
Therefore, the aim of the present study was to investigate the effect of a change in speech rate on listeners' ability to generate predictions while listening to a moderately degraded speech.
...
Lerner et al. (\protect\hyperlink{ref-Lerner2014}{2014}) also show that the central auditory-language processing system is flexible and can rescales itself according to the speed of incoming information,
i.e., the information processing speed in the auditory-language processing system can change in accordance with the change in speech rate,
but there is an upper limit to the system's flexibility.
...
Studies from Visual World Paradigm also support this claim that slow speech provides more time for speech processing and semantic predictions (\protect\hyperlink{ref-Fernandez2020}{Fernandez et al., 2020}; \protect\hyperlink{ref-Huettig2016}{Huettig \& Mani, 2016}).
...
Similarly, prediction itself is a time- and resource-consuming mechanism (\protect\hyperlink{ref-Pickering2018}{Pickering \& Gambi, 2018}) which is affected by a comprehender's processing speed (e.g., \protect\hyperlink{ref-Huettig2016}{Huettig \& Mani, 2016}).
...
We systematically examined whether contextual facilitation at a moderate level of degradation varies with a change in speech rate.
That is, the aim of this study was to investigate whether an increase (and decrease) in speech rate reduces (and amplifies) the facilitatory effect of semantic predictability.
...
The processing demand increases, and a limited time is to be available to process the context and generate predictions with an increase in speech rate (e.g., \protect\hyperlink{ref-Aydelott2004}{Aydelott \& Bates, 2004}; \protect\hyperlink{ref-Wlotko2015}{Wlotko \& Federmeier, 2015}; see also \protect\hyperlink{ref-Pickering2018}{Pickering \& Gambi, 2018}).
...
We used a subset of materials created by the method described in Chapter \ref{chapter-methods} (Section \ref{experimental-materials}) in this experiment.
120 sentences each for low predictability and high predictability sentences that differed in the cloze probability of sentence final target words were used.
...
Then the recordings of speech signal at fast rate and normal rate were both passed through 4 channels of noise-vocoding to create moderately degraded speech stimuli of two types: fast speech and normal speech (see Chapter \ref{chapter-methods} Section \ref{noise-vocoding} for details).
...
This resulted from a significant reduction in accuracy at the low predictability condition rather than due to an increase in accuracy at high predictability condition in the fast speech.
...
but it did not increase with a decrease is speech rate.
...
In contrast to Experiment 1, the findings of Experiment 2 did not indicate a differential effect of speech rates in the comprehension of high and low predictability sentences.
...
This argument is in line with the findings of M. B. Winn \& Teece (\protect\hyperlink{ref-Winn2021}{2021}), who reported that contextual facilitation does not increase when the speech is slowed down.
...
Our results show that when the moderately degraded speech is speeded up, the context is still robust:
...
Therefore, we conducted a set of complementary analyses (see the Supplementary Material) that supports the prediction-based explanation.
...
It can be speculated that when the speech is expanded to different levels by including other expansion factors, an increase in facilitatory effect could be observed.
...
In contrast, slowing down of the moderately degraded speech did not provide any benefit in the comprehension of high or low predictability sentences.
...
We talk about the limitations of the studies, their generalization, and future outlook.

\hypertarget{chapter-conclusion}{%
\chapter{Discussion and conclusion}\label{chapter-conclusion}}

In this chapter we present a closing remark on \emph{the interaction of top-down predictive and bottom-up auditory processing in comprehension of degraded speech}.
...
It is to say that, attention can limit predictability effect: \emph{no attention, no prediction}, in degraded speech comprehension.
...
These findings refute the claim of \emph{narrowed expectations} frameword proposed by Strauß et al. (\protect\hyperlink{ref-Strauss2013}{2013}).
...
Despite being certain about the speech quality of subsequent trials in the \emph{predictable channel context}, in Chapter 5,
...
\section{Probabilistic prediction in a noisy channel}\label{probabilistic-prediction-in-a-noisy-channel}}

\hypertarget{revisiting-the-goals}{%
\section{Revisiting the goals}\label{revisiting-the-goals}}
...
\hypertarget{replication-of-the-predictability-effect-in-a-noisy-channel}{%
\subsection{Replication of the predictability effect in a noisy channel}\label{replication-of-the-predictability-effect-in-a-noisy-channel}}
...
These findings are qualitatively similar to Obleser et al. (\protect\hyperlink{ref-Obleser2007}{2007}) and Obleser \& Kotz (\protect\hyperlink{ref-Obleser2010}{2010}) who also found similar effects at 8-channel and 4-channel noise-vocoding, respectively.
...
\hypertarget{nature-of-prediction-1}{%
\subsection{Nature of prediction}\label{nature-of-prediction-1}}
...
Only Strauß et al. (\protect\hyperlink{ref-Strauss2013}{2013}) have proposed the nature of predictability effect in degraded speech comprehension.
...
\hypertarget{boundary-conditions-of-predictive-language-processing}{%
\subsection{Boundary conditions of predictive language processing}\label{boundary-conditions-of-predictive-language-processing}}
...
\hypertarget{adaptation-to-degraded-speech-1}{%
\subsection{Adaptation to degraded speech}\label{adaptation-to-degraded-speech-1}}
...
\hypertarget{speed-of-information-processing}{%
\subsection{Speed of information processing}\label{speed-of-information-processing}}
...
\hypertarget{metric-for-measurement-of-language-comprehension}{%
\subsection{Metric for measurement of language comprehension}\label{metric-for-measurement-of-language-comprehension}}
