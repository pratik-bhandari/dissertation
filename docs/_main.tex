...
One of the features that distinguishes us humans from other species is our ability to communicate using verbal language (\protect\hyperlink{ref-Lieberman2013}{Lieberman, 2013}).
...
and infers the intended meaning of the speaker from the perceived meaning that it receives from a noisy channel of communication (\protect\hyperlink{ref-Gibson2013}{Gibson et al., 2013}; e.g., \protect\hyperlink{ref-Levy2008}{Levy, 2008}).
...
Most readers would expect the final word to be \emph{a kite} in this sentence (\protect\hyperlink{ref-Delong2005}{DeLong et al., 2005}; cf. \protect\hyperlink{ref-Nieuwland2020a}{Nieuwland et al., 2020}). Here, the words up to the final word of the sentence provide a context:
...
Listeners use context information from what they have heard, and form predictions about upcoming word (e.g., \protect\hyperlink{ref-Altmann2007}{Altmann \& Kamide, 2007}; \protect\hyperlink{ref-Ankener2019}{Ankener, 2019}).
...
They put different weight on the prior knowledge and context information, and on the auditory information (\protect\hyperlink{ref-Obleser2007}{Obleser et al., 2007}; \protect\hyperlink{ref-Sheldon2008a}{Sheldon et al., 2008a}).
...
We investigate how top-down predictive processes facilitate language comprehension when the speech signal is \protect\hyperlink{speech-processing}{acoustically degraded}.
...
\item
  ...
  The first goal of this thesis is to test if the standard facilitatory effect of predictability in degraded speech comprehension (\protect\hyperlink{ref-Obleser2007}{Obleser et al., 2007}; \protect\hyperlink{ref-Sheldon2008a}{Sheldon et al., 2008a}) is replicable.
...
\item
  ...
  At the same time, many studies have shown boundary conditions of predictive language processing, for example, working memory, aging, experimental paradigm, literacy, etc. (\protect\hyperlink{ref-Federmeier2010}{K. D. Federmeier et al., 2010}; \protect\hyperlink{ref-Huettig2019}{Huettig \& Guerra, 2019}; \protect\hyperlink{ref-Huettig2016}{Huettig \& Mani, 2016}; \protect\hyperlink{ref-Mishra2012}{Mishra et al., 2012}) which modulate the facilitatory effect of predictability.
  In this thesis, the role of attention to speech stream is of interest, as we know from non-speech auditory perception literature that attention can modulate and limit predictability effects (\protect\hyperlink{ref-Kok2012}{Kok et al., 2012}).
...
\item
  ...
  We advocate for the use of the metric that takes into account whether participants (in)correctly use the context evoking word in a sentence.
\end{enumerate}
...
\hat{m_p} &= \mathop{\mathrm{argmax}}\limits_{m_p} P(m_p | u_p, N)\\ \label{eq:noisy-channel3}
