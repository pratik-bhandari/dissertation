...
\item
  ...
  This thesis attempts to test if predictability effect reported by Obleser and colleagues in degraded speech comprehension \autocite{Obleser2007,Obleser2010} is replicable.
\item
...
\item
  ...
  Goal 6 corresponds to this research contribution which is brought about by consistent use of this metric in \protect\hyperlink{chapter-graded-prediction}{Chapters 6} and \protect\hyperlink{chapter-speech-rate}{7}.
\item
  ...
  Goals 1 and 2 correspond to this research contribution which is brought about by the experiment described in \protect\hyperlink{chapter-graded-prediction}{Chapter 6}.
\item
  ...
  Goal 3 corresponds to this research contribution which is brought about by the experiment described in \protect\hyperlink{chapter-attention-prediction}{Chapter 5}.
\item
  ...
  Goal 4 corresponds to this research contribution which is brought about by the experiment described in \protect\hyperlink{chapter-speech-rate}{Chapter 7}.
\item
  ...
  Goal 5 corresponds to this research contribution which is brought about by the experiment described mainly in \protect\hyperlink{chapter-graded-prediction}{Chapter 6}, and continued in \protect\hyperlink{chapter-speech-rate}{Chapter 7}.
\end{itemize}
...
\textbf{\protect\hyperlink{chapter-background}{Chapter 2}} provides a background on the rest of the chapters.
...
\textbf{\protect\hyperlink{chapter-methods}{Chapter 3}} describes the stimuli used in all the experiments in this thesis.
It describes the process of stimuli creation, speech processing, and also provies an overview of online data collection.

\textbf{\protect\hyperlink{chapter-stats}{Chapter 4}} provides a description of the statistical tests employed for data analyses.
...
\textbf{\protect\hyperlink{chapter-graded-prediction}{Chapter 6}} addresses the first, the second, the fifth, and the sixth research goals.
The predictability effect that was partially replicated in \protect\hyperlink{chapter-attention-prediction}{Chapter 5} is further examined in this chapter.
...
\textbf{\protect\hyperlink{chapter-speech-rate}{Chapter 7}} addresses the questions opened in \protect\hyperlink{chapter-graded-prediction}{Chapter 6}.
In two experiments, it addresses the fourth, the fifth, and this sixth research goals.
We use the same metric of measurement of language comprehension as \protect\hyperlink{chapter-graded-prediction}{Chapter 6}, which takes into account listeners' correct identification of the context.
Listeners were presented with a moderately degraded speech at which we observed predictability effect in \protect\hyperlink{chapter-graded-prediction}{Chapter 6}.
...
\textbf{\protect\hyperlink{chapter-conclusion}{Chapter 8}} summarizes the findings of all the studies.
...
\textbf{\protect\hyperlink{chapter-ethics}{Chapter 9}} presents ethical approval that was obtained to run the experiments on human subject.
...
Response accuracy was analyzed with Generalized Linear Mixed Models (GLMMs) following the procedure described in \protect\hyperlink{analysis-main}{Chapter 4}.
...
A few lacunae in the study warrant further examination to strengthen the conclusion.
Firstly, there was an implicit assumption that all the noun-correct responses were borne out of correct identification of the context evoking words (i.e., the verbs).
In the given experimental design made to test the effect of attention to context vs attention only to the target word, and by the virtue of the instruction given to the participants,
...
as the theoretical question was focused on the role of attention to context rather than on the nature of prediction.
...
Very few studies have investigated such theoretical questions within the domain of adverse listening conditions, specifically in degraded speech comprehension \autocites[e.g.][]{Strauss2013}[see also][]{Corps2020,vanOs2021}.
\textcite{Strauss2013} posited that listeners cannot preactivate less predictable sentence endings in an adverse listening condition.
...
Although many studies support the general idea of Strauß and colleagues that predictability facilitates comprehension of degraded speech \autocites[e.g.,][]{Sheldon2008a,Obleser2010,Hunter2018},
...
that some studies \autocites{Sheldon2008a,Obleser2007,Obleser2010}[see also,][]{Hunter2018} have already shown the facilitatory effect of predictability in comprehension of degraded speech.
Obleser and colleagues, for example, compared high and low predictability sentences and observed contextual facilitation, in terms of a difference in response accuracy between high and low predictability sentences, at 8 channels and 4 channels noise vocoded speech in their \autocite*{Obleser2007} and \autocite*{Obleser2010} studies respectively.
These studies, however, were not designed to test the nature of predictability effects.

In a modified experimental design, \textcite{Strauss2013} varied the target word predictability by manipulating its expectancy (i.e., how expected the target word is given the verb) and typicality (i.e., co-occurrence of target word and the preceding verb).
...
For example, \textcite{Nieuwland2018} showed in a large-scale replication study of \textcite{Delong2005} that the N400 amplitude at the sentence-final noun is directly proportional to its cloze probability across a range of high- and low-cloze words \autocites[see also,][]{Kochari2019,Nicenboim2020}.
\textcite{Heilbron2021} also showed that a probabilistic prediction model outperforms a constrained guessing model in predicting listeners' neural activities (MEG and EEG recordings),
...
\noindent
Listeners quickly adapt to novel speech with artificial acoustic distortions \autocite{Dupoux1997}.
With a repeated exposure to degraded speech, listeners' comprehension improves over time \autocite{Samuel2009,Guediche2014}.
When the noise condition is constant throughout the experiment, listeners adapt to it and the performance (e.g., word recognition) improves with as little as 20 minutes of exposure \autocite{Rosen1999}.
For example, \textcite[Experiment 1]{Davis2005} presented listeners with 6 channels noise vocoded speech and found an increase in the proportion of correctly reported words over the course of experiment.
Similarly, \textcite{Erb2013} presented participants with 4 channels noise vocoded speech and reached a similar conclusion.
...
it might be totally absent with the change in the characteristics of auditory signal throughout an experiment \autocite{Mattys2012}.
In addition, trial-by-trial variability in the characteristics of distorted speech can impair word recognition \autocites{Sommers1994}[see also,][]{Dahan2006}.
...
Listeners can adapt to auditory signal at different time courses or time scales \autocites{Atienza2002}[see also,][]{Whitmire2016}.
...
For example, words were presented at +3dB SNR and +10dB SNR in a word-recognition task in a pseudorandom order \autocite{Vaden2013}.
The authors wanted to minimize the certainty about the noise conditions in the block.
They proposed that an adaptive control system (cingulo-opercular circuit) might be involved to optimize task performance when listeners are uncertain about an upcoming trial \autocite{Vaden2015,Vaden2016,Eckert2016}.
...
Similarly, Obleser and colleagues \autocite{Obleser2007,Obleser2010,Hartwigsen2015} also presented listeners with noise vocoded sentences (ranging from 2 to 32 channels noise vocoding) in a pseudo-randomized order but did not report the presence or absence of perceptual adaptation.
...
Some studies that reported contextual facilitation in degraded speech comprehension used proportion of correctly reported \emph{final} words only \autocites[e.g.,][]{Sheldon2008a,Obleser2010,Hunter2018}.
\textcite{Obleser2007} quantified language comprehension as the proportion of correctly identified key words in SPIN sentences.
\textcite{Erb2013} and \textcite{Hakonen2017} used \emph{report scores} \autocite{Peelle2013} that measure proportion of correctly recognized words per sentence as an index of language comprehension.
Such inconsistancy makes cross-study comparison difficult,
and more importantly, none of these measures take into account if listeners have correctly identified the context \autocites[cf.][]{Amichetti2018}[see also,][]{Marrufo2019}
...
Based on previous findings, we expected that in the unpredictable channel context (i.e., when sentences are presented in a random order of spectral degradation) participants' word recognition performance will be worse than in the predictable channel context \autocites[i.e., when the sentences are blocked by noise-vocoding,][]{Sommers1994,Garrido2011,Vaden2013}.
...
We created \emph{unpredictable channel context} group from participants (n = 48; \(\bar{x}\) \(\pm\) SD = 24.44 \(\pm\) 3.5 years; age range = 18 -- 31 years; 16 females) from
...
We used the same stimuli described in \protect\hyperlink{experimental-materials}{Chapter 3}.
...
In the first block, all sentences were 8 channels noise vocoded, followed by the blocks of 6 channels, 4 channels, and 1 channel noise vocoded speech consecutively \autocite{Sheldon2008a}.
...
Following the procedure described in \protect\hyperlink{analysis-main}{Chapter 4}, response accuracy was analyzed with Generalized Linear Mixed Models (GLMMs).
...
Model selection was based on Akaike Information Criterion\autocite{Grueber2011,Richards2011}.
...
This trend is consistent across both the channel contexts;
...
than in the 4 channels (\(\beta\) = -2.87, SE = 0.22, \emph{z} (6917) = -13.1, \emph{p} \textless.001) and
6 channels (\(\beta\) = -0.66, SE = 0.19, \emph{z} (6917) = -3.42, \emph{p} \textless{} .001).
...
than both high predictability sentences (\(\beta\) = 2.18, SE = 0.3, \emph{z} (6917) = 7.2, \emph{p} \textless{} .001) and
medium predictability sentences (\(\beta\) = -0.52, SE = 0.27, \emph{z} (6917) = -1.97, \emph{p} = .049).
...
at both 6 channels (\(\beta\) = 0.33, SE = 0.32, \emph{z} (2590) = 1.04, \emph{p} = .3)
and 8 channels (\(\beta\) = -0.014, SE = 0. 32, \emph{z} (2719) = -0.04, \emph{p} = .97).
However, response accuracy was higher in high predictability than in medium predictability sentences
at both 6 channels (\(\beta\) = 1.83, SE = 0.65, \emph{z} (2590) = 2.83, p \textless{} .005)
and 8 channels (\(\beta\) = 1.54, SE = 0.61, \emph{z} (2719) = 2.54, \emph{p} = .011).
