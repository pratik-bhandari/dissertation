...
Most of the listeners would expect the final word to be \emph{kite} in this sentence.
...
This would lead them to expect that the sentence continuation is most likely \emph{kite} and not any other word.
This particular sentence was used by \textcite{ZYCG} in a reading study, but it applies to listening too \autocite[see][]{Altmann2007}.
...
At the same time, there is a set of studies showing limitations in \emph{prediction} in specific experimental paradigms, a special population (e.g., older adults, children, etc.). Limited studies in degraded speech comprehension are mostly in agreement that language comprehension is predictive in nature. It is to be tested whether prediction is inherent even in this adverse listening condition. Any finding, for or against the account of predictive language processing, would provide an insight to the overall framework of \emph{prediction as cognition}.
...
\hypertarget{perception-and-comprehension-of-degraded-speech}{%
\section{Perception and comprehension of degraded speech}\label{perception-and-comprehension-of-degraded-speech}}
...
\hypertarget{prediction-in-language-comprehension}{%
\section{Prediction in language comprehension}\label{prediction-in-language-comprehension}}

Continue from the previous paragraph that context helps in comprehension of degraded speech.
While listening to speech, listeners use the available context information and form predictions about upcoming linguistic event.
One of the earliest evidences on this predictive nature of language comprehension comes from
