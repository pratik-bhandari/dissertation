...
One of the significant contributors in our ability to understand language in such adverse listening condition is \emph{predictive language processing}.
...
The question we ask is whether the attention to the context is strictly necessary, regardless of the comprehenders \emph{hearing} it, to generate predictions about an upcoming word in a sentence at different levels of degradation.
...
New section: Counterarguments or Limitations or \ldots{} what could've been done \ldots{} alternative analyses/explanations/\ldots{}
- Alternative exp: If they understand the context correct, they could also understand the noun. They're not predicting; it is just like 8ch; simply following bottom-up. COUNTER: If so, then why effect of pred.?
