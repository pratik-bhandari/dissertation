...
Additionally, comparing the means of a categorical variable (correct vs. incorrect responses) even when transformed into accuracy or proportion scale is hard to interpret sensibly as compared to a continuous variable like reaction time [for discussion see @Bolker2009; @Jaeger2008].
...
the model with smallest AIC was selected as the best fitting model for our data [@Grueber2011; @Richards2011].  
