...
Thus, the experiments presented in this thesis suggest that listeners are *rational* comprehenders:
...
In their *good enough processing* framework, @Ferreira2016 speculated that a comprehender can focus and process one part of a sentence "deeper",
...
Therefore, we determined our sample size to be approximately equal to that of other studies that examined language comprehension in adverse listening conditions [e.g., @Erb2013; @Hunter2018; @Obleser2007; @Obleser2010; @Sheldon2008a; @Sheldon2008b; @Sommers2020; @Strauss2013].
...
The solution we recommend for future studies is to conduct an a priori power analysis and determine the sample size.
...
One of the goals of the thesis was to replicate the predictability effects in degraded speech comprehension, as shown in @Obleser2007 and @Obleser2010.
...
In future experiments, one could follow @Woods2017's proposed *headphone test* to confirm that streo headphones are used, not loudspeakers.

Similarly, hearing acuity correlates with the effort required to perceive words in adverse listening condition [@Cahana2016; @McCoy2005].
...
As a next step for the generalization and clinical translation of our findings,
