...
This thesis attempts to test if predictability effect reported by Obleser and colleagues in degraded speech comprehension [@Obleser2007; @Obleser2010; @Obleser2011] is replicable.
...
**Chapter 4** provides a description of the statistical tests employed for data analyses.
...
**Chapter 5** presents two experiments that address the first and the third research goal.
...
**Chapter 6** addresses the first, the second, the fifth, and the sixth research goals.
...
**Chapter 7** addresses the questions opened in Chapter 6.
...
**Chapter 9** summarizes the findings of all the studies.
...
**Chapter 10** presents ethical approval that was obtained to run the experiments on human subject.
