...
This weighing of top-down and bottom-up processes is considered as a rational process in the models of probabilistic language processing in reading comprehension [@Levy2008; @Ryskin2018; see also @vanOs2021 for an implementation of the rational approach in language comprehension in background noise].
