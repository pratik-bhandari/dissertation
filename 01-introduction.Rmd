...
This can be expressed formally as[^formalization-footnote]:
...
(5)   **To examine the effect of speed speech rate**\
...
[^formalization-footnote]: The mathematical formalisation presented in this thesis is intended to introduce and conceptually clarify the noisy channel model of communication and not to simulate or model the communication that occurs in a noisy channel.
...
<!-- , see Chapter \@ref(chapter-conclusion) for further discussion]. -->
