...
These sequence of events from the intended message $m_i$ to the perceived message $m_p$ can be graphically represented in a Bayesian network [@Darwiche2010; @Bruineberg2021; @Pearl1985] in Figure \ref{fig:bayesian-network} (cf. Figure \ref{fig:noisy-channel}).
...
(1) The day was breezy so the boy went outside to fly ...\label{kite}
...
will help gather evidence in the favor of this *effect of interest*.
...
There are at least two schools of thought which argue that prediction is either all-or-nothing or probabilistic in nature [@Coltheart2004; @Kuperberg2016; @Luke2016].
