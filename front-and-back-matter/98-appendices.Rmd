...
: Sentences with cloze probability of the target word (noun) the source of the sentences as mentioned in Chapter 5
...
These model estimates, i.e., the effect of noun-correct trials ($\beta_{{noun}_{Exp1}}$ = .73 and $\beta_{{noun}_{Exp2}}$ = .78) are smaller than the model estimates of verb-correct trials presented in Chapter \@ref(chapter-speech-rate) ($\beta_{{verb}_{Exp1}}$ = 2.42 and $\beta_{{verb}_{Exp2}}$ = 2.58).
This supports the interpretation of forward-prediction much strongly than backward guessing.
